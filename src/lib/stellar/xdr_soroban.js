...
var types = XDR.config(function (xdr) {
  ...
  //
  // ===========================================================================
  xdr.struct('CreateContractArgs', [['contractId', xdr.lookup('ContractId')], ['executable', xdr.lookup('ScContractExecutable')]])
  ...
  xdr.union('HostFunctionArgs', {
    ...
    switchName: 'type',
    switches: [['hostFunctionTypeInvokeContract', 'invokeContract'], ['hostFunctionTypeCreateContract', 'createContract'], ['hostFunctionTypeUploadContractWasm', 'uploadContractWasm']],
    arms: {
  ...
  //
  // ===========================================================================
  xdr.struct('HostFunction', [['args', xdr.lookup('HostFunctionArgs')], ['auth', xdr.varArray(xdr.lookup('ContractAuth'), 2147483647)]])
  ...
  //
  // ===========================================================================
  xdr.struct('InvokeHostFunctionOp', [['functions', xdr.varArray(xdr.lookup('HostFunction'), xdr.lookup('MAX_OPS_PER_TX'))]])
  ...
  //
  // ===========================================================================
  xdr.struct('HashIdPreimageCreateContractArgs', [['networkId', xdr.lookup('Hash')], ['executable', xdr.lookup('ScContractExecutable')], ['salt', xdr.lookup('Uint256')]])
  ...
  //
  // ===========================================================================
  xdr.struct('SorobanTransactionData', [['resources', xdr.lookup('SorobanResources')], ['refundableFee', xdr.lookup('Int64')], ['ext', xdr.lookup('ExtensionPoint')]])
  ...
  //
  // ===========================================================================
  xdr.struct('ContractCostParamEntry', [['constTerm', xdr.lookup('Int64')], ['linearTerm', xdr.lookup('Int64')], ['ext', xdr.lookup('ExtensionPoint')]])
