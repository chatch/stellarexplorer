...
const effectsRecords = [	import effectsRecords from './__data__/effects'
...
test('jsonToCSV', () => {	describe('jsonToCSV', () => {
  expect(jsonToCSV(effectsRecords)).toMatchSnapshot()	  test('effects', () => {
