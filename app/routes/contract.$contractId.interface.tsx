...
const Interface = (
  ...
  <div>
    <div id="cli-info">
      The Rust interface below was produced by the <a href="https://github.com/stellar/soroban-tools/blob/v20.0.0-rc2/docs/soroban-cli-full-docs.md#soroban-contract-bindings">soroban contract bindings</a> command.
    </div>
    <CodeBlock
      code={rustInterface}
      language="rust"
