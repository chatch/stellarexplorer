          ...
          {this.props.isExportingFinished === true ? (
            this.props.exportLimitExceeded === true ? (
              <FormattedMessage
                ...
                values={{
                  count:
                    has(this.props, 'fetchedRecords') &&
                    this.props.fetchedRecords.length,
                }}
              />
            ) : (
              <FormattedMessage
                id={
                  this.props.fetchedRecords.length > 0
                    ? 'csv-export.complete'
                    : 'csv-export.no-records'
                }
                values={{
                  count:
                    has(this.props, 'fetchedRecords') &&
            ...
            <div>
              <FormattedMessage id="csv-export.fetching" /> |{' '}
              <FormattedMessage
                id="csv-export.fetched"
                values={{ count: this.props.fetchedRecords.length }}
              />
            </div>
          )}
        </div>
